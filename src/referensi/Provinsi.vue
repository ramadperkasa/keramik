<template>
  <app>
    <v-row>
      <v-col cols="8">
        <span class="title pl-2">Provinsi</span>
      </v-col>
      <v-spacer></v-spacer>
    ...
    <v-dialog v-model="dialog.alert.model" max-width="500">
      <v-card>
        <v-card-title class="title">Apakah anda yakin ingin hapus data Provinsi ini?</v-card-title>
        ...
        <v-card-text>
          <v-row>
            ...
            <v-col cols="11">
              ...
              anda yakin ingin menghapus data Provinsi ini?
            </v-col>
          </v-row>
        </v-card-text>
        <v-divider></v-divider>
    ...
    <v-dialog v-model="dialog.form.model" persistent width="750">
      <v-card>
        <v-card-title primary-title>
          <v-icon class="pr-2">{{ icon_form }}</v-icon>Input Data Provinsi
          <v-spacer></v-spacer>
        ...
        <v-container>
          <v-card-text>
            <v-row>
              <v-col cols="3">
                <v-text-field v-model="form.id" label="ID *" hint="Contoh : 32"></v-text-field>
              </v-col>
              <v-col cols="9">
                <v-text-field
        ...
        <v-card-actions>
          ...
          <v-btn
            ...
            text
            @click="form.isEdit ? updateNewProvinsi() : createNewProvinsi()"
          >
          ...
          <v-btn
            ...
            :disabled="dialog.form.loading"
            text
            @click="form.isEdit ? updateProvinsi() : createProvinsi()"
          >
...
export default {
  ...
  methods: {
    ...
    editItem(item) {
      ...
      this.form.nama_provinsi = item.nama_provinsi;
    },
    destroyItem(item) {
