      ...
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn
            ...
            @click="
              form.isEdit
                ? updateNewProdukKategori()
                : createNewProdukKategori()
            "
          >
          ...
          <v-btn
            ...
            text
            @click="
              form.isEdit ? updateProdukKategori() : createProdukKategori()
            "
          >
...
export default {
    ...
    return {
      ...
      table: {
        ...
        headers: [
          ...
          {
            text: "Nama Produk Kategori",
            value: "nama_produk_kategori",
            align: "left"
          },
          {
            text: "Action",
  ...
  watch: {
    ...
    search(newValue) {
      ...
      this.fetchProdukKategori(newValue);
    }
  },
  computed: {
    search() {
  ...
  methods: {
    ...
    addItem() {
      ...
      this.form.id = "";
      this.form.nama_produk_kategori = "";
    },
    editItem(item) {
      this.dialog.form.model = true;
      this.form.isEdit = true;
      this.form.id = item.id;
      this.form.nama_produk_kategori = item.nama_produk_kategori;
    },
    destroyItem(item) {
