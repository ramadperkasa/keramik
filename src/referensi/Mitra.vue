<template>
  <app>
    <v-row>
      <v-col cols="8">
        <span class="title pl-2">Mitra</span>
      </v-col>
      <v-spacer></v-spacer>
    ...
    <v-dialog v-model="dialog.alert.model" max-width="500">
      <v-card>
        <v-card-title class="title"
          >Apakah anda yakin ingin hapus data Mitra ini?</v-card-title
        >
        ...
        <v-card-text>
          <v-row>
            ...
            <v-col cols="11"
              ...
              anda yakin ingin menghapus data Mitra ini?</v-col
            >
          </v-row>
        </v-card-text>
        <v-divider></v-divider>
      ...
      <v-card>
        ...
        <v-container>
          <v-card-text>
            ...
            ></v-text-field>
            <v-text-field
              v-model="form.status_mitra"
              label="Status Mitra *"
              hint="Contoh : Dipointer"
            ></v-text-field>
            <v-text-field
              v-model="form.tgl_registrasi"
        ...
        <v-card-actions>
          ...
          <v-btn
            ...
            text
            @click="form.isEdit ? updateNewMitra() : createNewMitra()"
          >
          ...
          <v-btn
            ...
            :disabled="dialog.form.loading"
            text
            @click="form.isEdit ? updateMitra() : createMitra()"
          >
...
export default {
  ...
  methods: {
    ...
    addItem() {
      ...
      this.form.jk = "";
      this.form.agama_id = "";
      this.form.status_mitra = "";
      this.form.tgl_registrasi = "";
    },
    editItem(item) {
      this.dialog.form.model = true;
      ...
      this.form.status_mitra = item.status_mitra;
      this.form.tgl_registrasi = item.tgl_registrasi;
    },
    destroyItem(item) {
