<template>
  <app>
    <v-row>
      <v-col cols="8">
        <span class="title pl-2">Foto</span>
      </v-col>
      <v-spacer></v-spacer>
      ...
      <v-card>
        ...
        <v-container>
          <v-card-text>
            ...
            <v-text-field v-model="form.type_file" label="Type File *" hint="Contoh : Dipointer"></v-text-field>
        ...
        <v-card-actions>
          ...
          <v-btn
            ...
            text
            @click="form.isEdit ? updateNewFoto() : createNewFoto()"
          >
          ...
          <v-btn
            ...
            :disabled="dialog.form.loading"
            text
            @click="form.isEdit ? updateFoto() : createFoto()"
          >
...
export default {
  ...
  methods: {
    ...
    editItem(item) {
      ...
      this.form.type_file = item.type_file;
